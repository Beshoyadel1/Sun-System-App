...
class MobileDataContainerDataAllFirstScreenInsuranceAdminSunList extends StatelessWidget {
  final String? imageSrc1,title1,subTitle1,title2,subTitle2,title3,subTitle3,title4,subTitle4,title5,subTitle5;
  const MobileDataContainerDataAllFirstScreenInsuranceAdminSunList({
    super.key,
    this.imageSrc1,
    this.title1,
    this.subTitle1,
