...
class TabCustomDataContainerDataOrderInAllSecondScreenInsuranceAdminSunList extends StatelessWidget {
  ...
  const TabCustomDataContainerDataOrderInAllSecondScreenInsuranceAdminSunList({
    super.key,
    this.onTap,
    this.isActive=false,
