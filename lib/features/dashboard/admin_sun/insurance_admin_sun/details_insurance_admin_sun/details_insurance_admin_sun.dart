...
import '../../../../../features/dashboard/admin_sun/insurance_admin_sun/details_insurance_admin_sun/screens/container_details_insurance_admin_sun.dart';
...
class DetailsInsuranceAdminSun extends StatelessWidget {
  const DetailsInsuranceAdminSun({super.key});
                  ...
                  children: [
                    Expanded(
                      child: SingleChildScrollView(
                          child: ContainerDetailsInsuranceAdminSun()
                      ),
                    ),
                  ],
                ),
