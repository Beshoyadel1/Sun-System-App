...
import '../../../../../../features/dashboard/admin_sun/service_providers_sun/all_service_providers_sun/screens/list_data_all_service_providers_sun.dart';
...
class AllServiceProvidersSun extends StatelessWidget {
  const AllServiceProvidersSun({super.key});
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              child: Padding(
                ...
                child: ListDataAllServiceProvidersSun(),
              ),
            ),
          ),
        ),
