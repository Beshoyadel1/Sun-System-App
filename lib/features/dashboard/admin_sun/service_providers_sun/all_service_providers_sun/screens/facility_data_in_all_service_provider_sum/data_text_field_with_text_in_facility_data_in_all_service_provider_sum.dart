...
class DataTextFieldWithTextInFacilityDataInAllServiceProviderSum
    extends StatelessWidget {
  const DataTextFieldWithTextInFacilityDataInAllServiceProviderSum({super.key});
        ...
        ? Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                TextWithTextFormFieldAsColumnWidget(
                  text: 'العنوان المختصر من 4 حروف',
                  hint: '',
                ),
                TextWithTextFormFieldAsColumnWidget(
                  text: 'رقم المبني',
