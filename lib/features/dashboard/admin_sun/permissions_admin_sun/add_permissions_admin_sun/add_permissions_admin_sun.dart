...
import '../../../../../../features/dashboard/admin_sun/permissions_admin_sun/add_permissions_admin_sun/screens/list_data_add_permissions_admin_sun.dart';
...
class AddPermissionsAdminSun extends StatelessWidget {
  const AddPermissionsAdminSun({super.key});
        ...
        Expanded(
          ...
          child: Scaffold(
                  ...
                  children: [
                    Expanded(
                      child: SingleChildScrollView(
                          child: ListDataAddPermissionsAdminSun()
                      ),
                    ),
                  ],
                ),
            ...
            bottomNavigationBar:ContainerLastTwoButtonInAddedMaintenanceAndInternalServicesInServiceSettings(
              textContainerRight: AppLanguageKeys.add,
            ),
          ),
        ),
      ],
