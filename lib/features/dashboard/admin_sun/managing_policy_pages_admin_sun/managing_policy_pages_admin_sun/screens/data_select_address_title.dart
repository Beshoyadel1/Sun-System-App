...
class DataSelectAddressTitle extends StatelessWidget {
  const DataSelectAddressTitle({super.key});
      ...
      child: Builder(
        builder: (context) {
          return Row(
            spacing: 10,
            children: [
              _buildItem(context, index: 0, text: AppLanguageKeys.aboutSun),
              _buildItem(context, index: 1, text: AppLanguageKeys.privacyPolicy),
              _buildItem(context, index: 2, text: AppLanguageKeys.termsAndConditions),
            ],
          );
        },
      ),
