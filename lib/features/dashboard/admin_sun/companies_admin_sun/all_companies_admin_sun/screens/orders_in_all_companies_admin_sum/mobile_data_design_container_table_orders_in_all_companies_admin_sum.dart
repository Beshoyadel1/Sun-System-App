...
class MobileDataDesignContainerTableOrdersInAllCompaniesAdminSum extends StatelessWidget {
  ...
  const MobileDataDesignContainerTableOrdersInAllCompaniesAdminSum({
    super.key,
    this.onTap,
    this.imageSrc1,
    this.title1,
