...
class TabCustomDataDesignContainerTableDriversInAllCompaniesAdminSum extends StatelessWidget {
  final void Function()? onTap;
  final String? imageSrc1,title1,subTitle1,imageSrc2,title2,subTitle2,imageSrc3,title3,subTitle3,title4,subTitle4;
  final bool? isNewOrder;
  const TabCustomDataDesignContainerTableDriversInAllCompaniesAdminSum({
    super.key,
    this.onTap,
    this.imageSrc1,
    this.title1,
