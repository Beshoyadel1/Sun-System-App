...
import '../../../../../../features/dashboard/admin_sun/companies_admin_sun/all_companies_admin_sun/screens/list_data_all_companies_admin_sun.dart';
...
class AllCompaniesAdminSun extends StatelessWidget {
  const AllCompaniesAdminSun({super.key});
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              child: Padding(
                ...
                child: ListDataAllCompaniesAdminSun(),
              ),
            ),
          ),
        ),
