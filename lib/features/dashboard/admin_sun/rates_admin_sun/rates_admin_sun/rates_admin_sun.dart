...
import '../../../../../../features/dashboard/admin_sun/rates_admin_sun/rates_admin_sun/screens/list_data_rates_admin_sun.dart';
...
class RatesAdminSun extends StatelessWidget {
  const RatesAdminSun({super.key});
      ...
      children: [
        ...
        Expanded(
          ...
          child: Scaffold(
            ...
            appBar: AppbarDashboardWidget(title:AppLanguageKeys.reviews,imagePath: AppImageKeys.person22,),
            body: SafeArea(
              child: Padding(
