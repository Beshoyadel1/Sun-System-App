...
import '../../../../../../features/dashboard/admin_sun/rates_admin_sun/first_screen_rates_admin_sun/screens/list_data_first_screen_rates_admin_sun.dart';
...
class FirstScreenRatesAdminSun extends StatelessWidget {
  const FirstScreenRatesAdminSun({super.key});
            ...
            body: SafeArea(
              child: Padding(
                ...
                child: SingleChildScrollView(
                    child: ListDataFirstScreenRatesAdminSun()
                ),
              ),
            ),
          ),
