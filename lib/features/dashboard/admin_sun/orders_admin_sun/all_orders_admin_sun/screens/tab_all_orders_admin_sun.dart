...
import '../../../../../../features/dashboard/admin_sun/orders_admin_sun/all_orders_admin_sun/screens/all_orders_list/all_orders_list_in_all_orders_admin_sun.dart';
...
class TabAllOrdersAdminSun extends StatefulWidget {
  const TabAllOrdersAdminSun({super.key});

  @override
  State<TabAllOrdersAdminSun> createState() => _TabAllOrdersAdminSunState();
}

class _TabAllOrdersAdminSunState extends State<TabAllOrdersAdminSun> {
...
final List<Widget> widgetInsuranceOffers = const [
  AllOrdersListInAllOrdersAdminSun(),
  AllOrdersListInAllOrdersAdminSun(),
  AllOrdersListInAllOrdersAdminSun(),
  AllOrdersListInAllOrdersAdminSun(),
];
