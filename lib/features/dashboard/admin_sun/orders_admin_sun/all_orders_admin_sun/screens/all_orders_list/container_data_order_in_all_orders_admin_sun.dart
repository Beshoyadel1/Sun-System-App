...
import '../../../../../../../features/dashboard/admin_sun/orders_admin_sun/all_orders_admin_sun/screens/all_orders_list/data_container_data_order_in_all_orders_admin_sun.dart';
import '../../../../../../../core/theming/colors.dart';

class ContainerDataOrderInAllOrdersAdminSun extends StatelessWidget {
  ...
  const ContainerDataOrderInAllOrdersAdminSun({
    super.key,
    this.widthMobile,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: DataContainerDataOrderInAllOrdersAdminSun(
