...
import '../../../../../../features/dashboard/admin_sun/car_auction_admin_sun/car_auction_admin_sun/screens/list_data_car_auction_admin_sum.dart';
...
class CarAuctionAdminSun extends StatelessWidget {
  const CarAuctionAdminSun({super.key});
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              child: Padding(
                ...
                child: ListDataCarAuctionAdminSum(),
              ),
            ),
          ),
        ),
