...
class ContainerMyDataCarChooseAdminSumWidget extends StatefulWidget {
  final int index;
  final String imageSrc;
  final String title;
  final String subTitle;

  const ContainerMyDataCarChooseAdminSumWidget({
    Key? key,
    required this.index,
  ...
  @override
  State<ContainerMyDataCarChooseAdminSumWidget> createState() => _ContainerMyDataCarChooseAdminSumWidgetState();
}

class _ContainerMyDataCarChooseAdminSumWidgetState extends State<ContainerMyDataCarChooseAdminSumWidget> {
      ...
      builder: (context, state) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: isPrimary ?AppColors.redColor:AppColors.greyColor),
