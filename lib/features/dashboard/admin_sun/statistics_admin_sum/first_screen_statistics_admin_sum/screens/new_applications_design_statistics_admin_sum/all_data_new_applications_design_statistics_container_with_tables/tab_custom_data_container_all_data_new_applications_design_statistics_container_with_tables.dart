...
class TabCustomDataContainerAllDataNewApplicationsDesignStatisticsContainerWithTables extends StatelessWidget {
  final void Function()? onTap;
  final String? imageSrc1,title1,subTitle1,imageSrc2,nameCar2,kindCar2,imageSrc3,title3,subTitle3,text5;
  const TabCustomDataContainerAllDataNewApplicationsDesignStatisticsContainerWithTables({
    super.key,
    this.onTap,
    this.imageSrc1,
    this.title1,
