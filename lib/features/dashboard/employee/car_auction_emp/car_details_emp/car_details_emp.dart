...
import '../../../../../../../../features/dashboard/employee/car_auction_emp/car_details_emp/screens/part_edit_delete_message/container_part_edit_delete_message.dart';
import '../../../../../../../../features/dashboard/employee/car_auction_emp/car_details_emp/screens/list_data_car_details_emp.dart';
...
class CarDetailsEmp extends StatelessWidget {
  const CarDetailsEmp({super.key});
                    ...
                    if ((!isMobile))
                      Expanded(
                        ...
                        child: Padding(
                          ...
                          child: SingleChildScrollView(
                            child: ContainerPartEditDeleteMessage()
                          ),
                        ),
                      ),
                  ],
