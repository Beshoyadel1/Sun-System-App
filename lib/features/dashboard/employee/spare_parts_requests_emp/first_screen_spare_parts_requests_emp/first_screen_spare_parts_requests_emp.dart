...
import '../../../../../../features/dashboard/employee/spare_parts_requests_emp/first_screen_spare_parts_requests_emp/screens/list_data_first_screen_spare_parts_requests_emp.dart';
...
class FirstScreenSparePartsRequestsEmp extends StatelessWidget {
  const FirstScreenSparePartsRequestsEmp({super.key});
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              child: Padding(
                ...
                child: ListDataFirstScreenSparePartsRequestsEmp(),
              ),
            ),
          ),
        ),
