...
import '../../../../../../features/dashboard/employee/mobility_requests_emp/first_screen_mobility_requests_emp/screens/list_data_first_screen_mobility_requests_emp.dart';
...
class FirstScreenMobilityRequestsEmp extends StatelessWidget {
  const FirstScreenMobilityRequestsEmp({super.key});
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              child: Padding(
                ...
                child: ListDataFirstScreenMobilityRequestsEmp(),
              ),
            ),
          ),
        ),
