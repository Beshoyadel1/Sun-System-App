...
import '../../../../../features/dashboard/notifications/first_screen_advertisements/screens/list_data_first_screen_notifications.dart';
      ...
      children: [
        ...
        Expanded(
          ...
          child: Scaffold(
            ...
            appBar: AppbarDashboardWidget(title:AppLanguageKeys.notifications,),
            body: SafeArea(
              child: Padding(
